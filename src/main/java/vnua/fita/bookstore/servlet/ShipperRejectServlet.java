...
public class ShipperRejectServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		updateResult = orderDAO.updateOrderShipperConfirm(orderId, imagePath, orderNo, Constant.REJECT_ORDER_STATUS);
		if(updateResult) {
