...
public class Order implements Comparable<Order> {
	...
	private String paymentImagePath; // đường dẫn ảnh chụp màn hình chuyển tiền hoặc phiếu
										// ATM
	private String imgConfirmReject; // đường dẫn ảnh xác nhận trả hàng
	...
	public String getImgConfirmReject() {
		return imgConfirmReject;
	}

	public void setImgConfirmReject(String imgConfirmReject) {
		this.imgConfirmReject = imgConfirmReject;
	}
